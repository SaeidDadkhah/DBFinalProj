...
public class Constants {
    ...
    public static final String C_CHANALS = "chanals";
    ...
    public static final String RQ_UPDATE_FREINDS = "update friends request";
    ...
    public static final String F_CHANNELS = "channels";
